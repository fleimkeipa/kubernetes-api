...
func (rc *PodsRepository) List(ctx context.Context, namespace string, opts metav1.ListOptions) (*corev1.PodList, error) {
...
func (rc *PodsRepository) Update(ctx context.Context, id string, pod *corev1.Pod, opts metav1.UpdateOptions) (*corev1.Pod, error) {
