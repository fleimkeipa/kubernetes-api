                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.NamespaceRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PodsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully updated the pod",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
